...
CREATE TABLE IF NOT EXISTS `db_blog_pessoal`.`table2` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_table2_tb_temas_idx` (`temas_id` ASC) VISIBLE,
  INDEX `fk_table2_tb_usuarios1_idx` (`usuarios_id` ASC) VISIBLE,
  CONSTRAINT `fk_table2_tb_temas`
    FOREIGN KEY (`temas_id`)
    REFERENCES `db_blog_pessoal`.`tb_temas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_table2_tb_usuarios1`
